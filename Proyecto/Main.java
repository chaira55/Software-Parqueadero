...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("5. Consultar Puntos de Carga para Vehículos Eléctricos Disponibles");
            System.out.println("6. Asignar Punto de Carga para Vehículos Eléctricos");
            System.out.println("7. Crear Servicio Adicional");
            System.out.println("8. Actualizar Servicio Adicional");
            System.out.println("9. Eliminar Servicio Adicional");
            System.out.println("10. Consultar Saldo del Cliente");
            System.out.println("11. Registrar Carga de Auto");
            System.out.println("12. Cancelar Servicio");
            ...
            switch (opcion) {
                ...
                case 5:
                    ...
                    for (PuntoCargaEV punto : puntosDisponibles) {
                        System.out.println("Ubicación: " + punto.getUbicacion() + ", Capacidad: " + punto.getCapacidad());
                    }
                    break;
                case 6:
                ...
                case 11:
                    ...
                    break;
                case 12:
                    System.out.print("Nombre del cliente para cancelar el servicio: ");
                    cliente = scanner.nextLine();
                    System.out.print("Descripción del servicio a cancelar: ");
                    String descripcion = scanner.nextLine();
                    servicio.cancelarServicio(cliente, descripcion);
                    break;
                case 0:
